...
class NotificationService:
    async def create_notification(self, db: AsyncSession, title: str, message: str, type: str, target_role: str = None, target_email: str = None, sender_role: str = None) -> Notification:
        notification_data = {
            "title": title,
            "message": message,
            "type": type,
    ...
    async def get_all_notifications(self, db: AsyncSession, role: str = None, email: str = None) -> list[Notification]:
        return await NotificationRepository.get_all_by_criteria(db, role=role, email=email)

    async def mark_all_as_read(self, db: AsyncSession, role: str = None, email: str = None) -> bool:
...
async def create_notification(db: AsyncSession, title: str, message: str, type: str, target_role: str = None, target_email: str = None, sender_role: str = None) -> Notification:
    return await notification_service.create_notification(db, title, message, type, target_role, target_email, sender_role)
...
async def mark_all_as_read(db: AsyncSession, role: str = None, email: str = None) -> bool:
    return await notification_service.mark_all_as_read(db, role, email)

...
from app.controllers.base_controller import BaseController, Get, Patch, Post, Put
...
class AdminController(BaseController):
    ...
    @Post("/register", response_model=AdminResponse, status_code=status.HTTP_200_OK)
    ...
    @Get("/profile/{admin_id}", response_model=AdminResponse)
    ...
    @Put("/profile/{admin_id}", response_model=AdminResponse)
    ...
    @Post("/upload-profile-image/{admin_id}")
